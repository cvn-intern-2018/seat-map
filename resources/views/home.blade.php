        ...
        <div class="row search-box">
            ...
            <form role="form" action="/" method="get" class="">
                ...
                <div class=" col-md-offset-2 col-md-7">
                    <input onClick="this.select();" class="form-control form-control-lg form-control-borderless"
                           type="search" name="search" placeholder="Search topics or keywords" value="@isset($search)
                    {{$search}}
                    @endisset">
                </div>
                <!--end of col-->
                ...
                <div id="id01" class="modal">
                    ...
                    <form role="form" class="modal-content animate" action="/seat-map/add" method="post"
                        ...
                        <div class="sm-form">
                            ...
                            <input type="text" class="form-control sm-name" placeholder="Enter Seatmap's name"
                                   name="name" required>
